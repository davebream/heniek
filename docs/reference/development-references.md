...
|---|---|---|
| Predecessor orchestrator | Internal reference, intentionally unpinned in the public repository | Cognitive workflow contracts, evidence discipline, and critic/reviewer/verifier roles |
